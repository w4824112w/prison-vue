      ...
      success:function(data){
        ...
        $("#tTrolleys").DataTable({
          ...
          columns:[
            ...
            {data:'is_focus',"sWidth":"15%",render:function(data,type,row){
              if(data){
                return "<div><p style='text-align:left;margin-top:50px;'>是</p></div>";
              }
              return "<div><p style='text-align:left;margin-top:50px;'>否</p></div>";
            }}
          ],
          "columnDefs":[
            {
